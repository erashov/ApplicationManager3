...
namespace ApplicationManager.DAL
{
    public class IdentitySetup
    {
        ...
        public IdentitySetup(RoleManager<IdentityRole> roleManager, UserManager<UserEntity> userManager)
        {
        ...
        public async Task Setup()
        {
            ...
            var user = await _userManager.FindByNameAsync("admin@akado.com");
